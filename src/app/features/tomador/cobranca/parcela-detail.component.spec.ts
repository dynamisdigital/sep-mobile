...
describe('ParcelaDetailComponent', () => {
  ...
  it('data invalida nao vira 1969 nem derruba a tela', () => {
    ...
    const view = component as unknown as {
      ...
      dataRecebimentoFormatada(d: string): string;
    };
    ...
    expect(view.dataRecebimentoFormatada(null as unknown as string)).toBe('');
    expect(() => view.dataRecebimentoFormatada('lixo')).not.toThrow();
    expect(view.dataRecebimentoFormatada('2026-09-14T12:00:00Z')).toContain('14/09/2026');
  });
});
